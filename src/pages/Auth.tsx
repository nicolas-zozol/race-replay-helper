...
const Auth = () => {
  ...
  const handleGoogleLogin = async () => {
    try {
      ...
      if (error) throw error;
      // Google login will redirect, and we'll handle step 2 after successful auth
    } catch (error: any) {
      toast({
        title: "Error",
        description: error.message,
      ...
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            {step === 1 ? (
              ...
              "Choose how you want to receive race updates"
            )}
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="grid gap-6">
          {step === 1 ? (
            ...
            <form onSubmit={handleNotificationPreferences} className="grid gap-4">
              <div className="grid gap-2">
